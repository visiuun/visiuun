(function() {
  ...
  function createCookieBanner() {
    ...
    banner.style.whiteSpace = 'normal'; // Prevent text wrapping
    banner.style.transition = 'opacity 0.5s ease, transform 0.5s ease'; // Smooth transition for fading out and moving up
